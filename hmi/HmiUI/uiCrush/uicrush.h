...
QT_BEGIN_NAMESPACE
namespace Ui { class uiCrush; }
QT_END_NAMESPACE

class uiCrush : public QWidget
{
    Q_OBJECT

public:
    uiCrush(QWidget *parent = NULL);
    ~uiCrush();
...
//    WorkStateChoice* workChoice;
    AbnormalCrush* abnormalChoice;

    CmdDealClass* hmicmd;



    StopPoints *parkingPointItem=NULL;
    ...
    QList<latlngheading* > parkingList;
