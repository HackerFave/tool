...
QT_BEGIN_NAMESPACE
namespace Ui { class uiCollector; }
QT_END_NAMESPACE

class uiCollector : public QWidget
{
    Q_OBJECT

public:
    uiCollector(QWidget *parent = NULL);
    ~uiCollector();
...
//    WorkStateChoice* workChoice;
    AbnormalCollector* abnormalChoice;
