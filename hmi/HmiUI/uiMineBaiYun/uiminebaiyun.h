#ifndef UIMINEBAIYUN_H
#define UIMINEBAIYUN_H
...
#include "HmiUI/uiMine/workstatechoice.h"
#include "HmiUI/uiMine/faultminechoice.h"
...
QT_BEGIN_NAMESPACE
namespace Ui { class uiMineBaiyun; }
QT_END_NAMESPACE

class uiMineBaiyun : public QWidget
{
    Q_OBJECT

public:
    uiMineBaiyun(QWidget *parent = NULL);
    ~uiMineBaiyun();
...
private slots:
    ...
    void g2hDownTaskFileSlot(bool, QString,QStringList); //下载任务文件
    ...
    void on_loadDiffBtn_clicked();

    void on_fullunLoadBtn_clicked();

    void on_emptyLoadBaiyunBtn_clicked();

    void on_halfunLoadBtn_clicked();

    void on_emptyunLoadBtn_clicked();

    void on_emptyunLoadOkBtn_clicked();

    void on_emptyunLoadBackBtn_clicked();

    void on_halfunLoadOkBtn_clicked();

    void on_halfunLoadBackBtn_clicked();

    void on_fullunLoadOkBtn_clicked();
